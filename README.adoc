...
JBang installers and the link:https://github.com/jbangdev/setup-jbang[setup-jbang] GitHub Action put it. Unless
`version` is `latest`, this installation is only used when it is the requested version.
